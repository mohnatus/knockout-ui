 ...
 *
 * localValue {observable<[Moment, Moment]>} - внутренняя копия актуального значения
 * from {observable<Moment|null>}
 * to {observable<Moment|null>}
 * onPeriodChange {function} - для подписки на изменение компонентов
 * setPeriodComponent {function} - при выборе даты
 * dispose {function}
 */
